...
namespace MyBookmark
{
    ...
    static class GuidList
    {
        ...
        public static readonly Guid guidBookmark = new Guid("{ADC98052-0000-41D1-A6C3-704E6C1A3DE2}");
        // The guid of the source control provider service (implementing IVsBookmark interface)
        public static readonly Guid guidBookmarkService = new Guid("{ADC98052-1000-41D1-A6C3-704E6C1A3DE2}");
        // The guid of the source control provider package (implementing IVsPackage interface)
        public static readonly Guid guidMyPackage = new Guid("{ADC98052-2000-41D1-A6C3-704E6C1A3DE2}");
        // Other guids for menus and commands
        public static readonly Guid guidBookmarkCmdSet = new Guid("{ADC98052-5743-4feb-a929-2938249cba26}");
    };
}
